...
`datafusion-nexus` (check [diff](https://github.com/rapidsai/cugraph/compare/v26.04.00...DataFusion-Nexus:cugraph:datafusion-cugraph)).

## Base

- Upstream: NVIDIA RAPIDS cuGraph
- Base tag: `v26.04.00`
- Base commit in this repository: `03ba9c2d6`
